...
async function importCSV() {
  ...
  //   "Energy Pruchased (Electricity)": row["Energy Pruchased (Electricity)"],
  //   "Energy (Diesel)": row["Energy (Diesel)"],
  //   "Total Waste": row["Total Waste"],
  //   "Total Hazardous Waste (Landfil)": row["Total Hazardous Waste (Landfil)"],
  ...
  //   "Non-Hazardous Waste (Disposal)": row["Non-Hazardous Waste (Disposal)"],
  ...
  //     row["Cost of Water (Sweat) Purchase_Treatment_Water Waste_Disposal"],
  ...
  //   "Total Area (Floor Covered Area)": row["Total Area (Floor Covered Area)"],
  //   "Intensity - Water": row["Intensity - Water"],
  //   "Intensity - Energy": row["Intensity - Energy"],
  //   "Intensity - Energy (Electricity)": row["Intensity - Energy (Electricity)"],
